...
public class PushableBlockRes : MonoBehaviour
{

    public static PushableBlockRes instance;
    ...
    public PushableBlockRes pushableBlockMagnet;
    ...
    public class CommandMove : ICommand
    {
        ...
        public void Execute()
        {
            ...
            mGameObject.GetComponent<PushableBlockRes>().destination = mGameObject.transform.position + mDirection;

            mGameObject.GetComponent<PushableBlockRes>().moveblockNo++;
    ...
    void Update()
    {
        ...
        if (Vector3.Distance(transform.position, destination) < Mathf.Epsilon )
            ...
            PlayerControllerRes.instance.canMove = true;
    ...
    public void Push(Vector3 direction, float speed)
    {
        ...
        if (!isPushed)
        {
            ...
            {
                if (Vector3.Distance(PlayerControllerRes.instance.transform.position, PlayerControllerRes.instance.Destination) < Mathf.Epsilon)
                {
                    // Debug.Log("ImPushed");
                ...
                //    Icommand command = new PushRockCommand(this.gameObject, direction);
                  //  CommandInvoker.AddCommand(command);
                    ...
                    isPushed = true;
                    PlayerControllerRes.instance.MovePlayer(direction);
        ...
        if (hit.collider != null)
        {
          ...
          //  if (hit.collider.gameObject.CompareTag("Pushable"))
           // {
                ...
                if (!PlayerControllerRes.instance.isStrong)
                {
                    return false;
                }
                else
